...
Debug/error.doj :error.c error.h $(VDSP)/Blackfin/include/stdio.h $(VDSP)/Blackfin/include/yvals.h $(VDSP)/Blackfin/include/sys/stdio_bf.h 
	@echo ".\error.c"
	$(VDSP)/ccblkfn.exe -c .\error.c -file-attr ProjectName=szakdoga -O -Ov100 -ipa -g -Oa -structs-do-not-overlap -no-multiline -D ETSI_SOURCE -D __SET_ETSI_FLAGS=1 -double-size-64 -decls-strong -flags-compiler --diag_warning,implicit_func_decl -warn-protos -l etsi*co -si-revision 0.2 -proc ADSP-BF537 -o .\Debug\error.doj -MM
...
Debug/state.doj :state.c global.h global_var.h $(VDSP)/Blackfin/include/fract.h $(VDSP)/Blackfin/include/fract_typedef.h $(VDSP)/Blackfin/include/fract_math.h $(VDSP)/Blackfin/include/ccblkfn.h $(VDSP)/Blackfin/include/stdlib.h $(VDSP)/Blackfin/include/yvals.h $(VDSP)/Blackfin/include/stdlib_bf.h $(VDSP)/Blackfin/include/builtins.h $(VDSP)/Blackfin/include/sys/builtins_support.h $(VDSP)/Blackfin/include/fr2x16_typedef.h $(VDSP)/Blackfin/include/r2x16_typedef.h $(VDSP)/Blackfin/include/raw_typedef.h $(VDSP)/Blackfin/include/sys/anomaly_macros_rtl.h $(VDSP)/Blackfin/include/sys/mc_typedef.h $(VDSP)/Blackfin/include/fr2x16_math.h $(VDSP)/Blackfin/include/fr2x16_base.h $(VDSP)/Blackfin/include/r2x16_base.h $(VDSP)/Blackfin/include/libetsi.h $(VDSP)/Blackfin/include/fract2float_conv.h $(VDSP)/Blackfin/include/complex.h $(VDSP)/Blackfin/include/complex_typedef.h $(VDSP)/Blackfin/include/cycles.h $(VDSP)/Blackfin/include/xcycle_count.h $(VDSP)/Blackfin/include/limits.h $(VDSP)/Blackfin/include/cycle_count_bf.h error.h $(VDSP)/Blackfin/include/sys/exception.h $(VDSP)/Blackfin/include/stdio.h $(VDSP)/Blackfin/include/sys/stdio_bf.h 
	@echo ".\state.c"
	$(VDSP)/ccblkfn.exe -c .\state.c -file-attr ProjectName=szakdoga -O -Ov100 -ipa -g -Oa -structs-do-not-overlap -no-multiline -D ETSI_SOURCE -D __SET_ETSI_FLAGS=1 -double-size-64 -decls-strong -flags-compiler --diag_warning,implicit_func_decl -warn-protos -l etsi*co -si-revision 0.2 -proc ADSP-BF537 -o .\Debug\state.doj -MM
...
./Debug/szakdoga.dxe :./ADSP-BF537.ldf $(VDSP)/Blackfin/lib/bf534_rev_0.0/crtsf532y.doj ./Debug/ecomplex.doj ./Debug/generate.doj ./Debug/initialize.doj ./Debug/interrupts.doj ./Debug/main.doj ./Debug/pzk_container.doj ./Debug/transform.doj ./Debug/error.doj ./Debug/implement.doj ./Debug/state.doj $(VDSP)/Blackfin/lib/cplbtab537.doj $(VDSP)/Blackfin/lib/bf534_rev_0.0/libsmall532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/__initsbsz532.doj $(VDSP)/Blackfin/lib/bf534_rev_0.0/libio532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libc532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libm3free532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libevent532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libx532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libcpp532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libcpprt532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libf64ieee532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libdsp532y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/libsftflt532y.dlb $(VDSP)/Blackfin/lib/libetsi532.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/Debug/libssl537y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/Debug/libdrv537y.dlb $(VDSP)/Blackfin/lib/bf534_rev_0.0/idle532y.doj $(VDSP)/Blackfin/lib/bf534_rev_0.0/librt_fileio532y.dlb 
	@echo "Linking..."
	$(VDSP)/ccblkfn.exe .\Debug\ecomplex.doj .\Debug\error.doj .\Debug\generate.doj .\Debug\implement.doj .\Debug\initialize.doj .\Debug\interrupts.doj .\Debug\main.doj .\Debug\pzk_container.doj .\Debug\state.doj .\Debug\transform.doj -T .\ADSP-BF537.ldf -map .\Debug\szakdoga.map.xml -L .\Debug -add-debug-libpaths -flags-link -od,.\Debug -o .\Debug\szakdoga.dxe -proc ADSP-BF537 -si-revision 0.2 -flags-link -MM
